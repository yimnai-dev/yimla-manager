...
export declare class ScriptLetContext {
    ...
    nestSnippetBlock(id: ESTree.Identifier, closeParentIndex: number, snippetBlock: SvelteSnippetBlock, callback: (id: ESTree.Identifier, ctx: ESTree.Pattern | null) => void): void;
