...
export declare type TemplateNode = Text | MustacheTag | RawMustacheTag | DebugTag | ConstTag | RenderTag | Directive | StyleDirective | Element | InlineComponent | Window | Document | Body | Head | Title | Options | SlotTemplate | Slot | Comment | IfBlock | EachBlock | AwaitBlock | KeyBlock | SnippetBlock;
